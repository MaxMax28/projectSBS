...
//         .then(response => {
//
//             function allUsers (resp) {
//                 let userData = '';
//
//                 let allUsersList = new Set(resp);
//                 let roles = new Map()
//                 let key = 0
//
//                 for (let user of allUsersList) {
//                     for (let roleOfUser of user) {
//                         roles.set(key++, roleOfUser)
//                     }
//
//                     for(let user of allUsersList) {
//
...
//                         userData += '<td> <button type="button" id="updateButton" class="btn btn-primary" ' +
//                             'data-toggle="modal" th:attr="data-target=\'#modal\'+${user.id}" ' +
//                             //'data-id="' + user.id + '"' +
//                             '>update</button> ' +
//
//                             '<button type="button" id="deletingButton" class="btn btn-danger" ' +
//                             'data-toggle="modal" th:attr="data-target=\'#modal\'+\'delete\'+${user.id}" ' +
//                             //'data-id="' + user.id + '"' +
//                             '>delete</button>';
//                         userData += '</tr>';
//                     }
...
//     fetch('#updatingButton')
//         .then(response => {
//             function updateUser(newUser) {
//
//                 let updatingFormData = {
//                     name: newUser.name,
//                     password: newUser.password,
//                     role: newUser.role
//                 }
//                 return updatingFormData;
//             }
//             updateUser(response)
//         })
// }
...
async function getUsers() {
    //url changed
    let url = "http://localhost:8080/admin/allUsers";
...
async function editModal() {
    ...
    let url = "http://localhost:8080/admin/update";
...
async function deleteModal() {
    ...
    let url = "http://localhost:8080/admin/delete";
